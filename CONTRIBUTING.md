...
- The title of the PR starts with chart name (e.g. `[origoss-labs/chart]`)

### PR Approval and Release Process

1. Changes are manually reviewed by Origoss Labs team members.
2. Once the changes are accepted, the PR is verified with a [Static analysis](TODO) that includes the lint and the vulnerability checks. If that passes, the Bitnami team will review the changes and trigger the verification and functional tests.
